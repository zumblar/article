...
\centering
\includegraphics[width=\linewidth]{../img/gaps.png}
\caption{Щели Кирквуда}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=\linewidth]{../img/gaps2.png}
...
$$U(x,y) = C(x^2-y^2)+e_J Dx +e_J^2E, \qquad V(x,y) = 2Cxy+e_JDy.$$
