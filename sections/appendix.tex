...
\item Рассмотрим абстрактную 4 мерную быстро-медленную систему в медленном времени $\tau = \varepsilon t$:
\begin{equation}
    \left\{
    \begin{aligned}
        \varepsilon \frac{d \Lambda}{d\tau} &= g^\Lambda(\Lambda,\lambda,x,y),
        &\quad
        \varepsilon \frac{d \lambda}{d\tau} &= g^\lambda(\Lambda,\lambda,x,y),\\
        \frac{d x}{d\tau} &= g^x(\Lambda,\lambda,x,y),
        &\quad
        \frac{d y}{d\tau} &= g^y(\Lambda,\lambda,x,y).
    \end{aligned}
    \right.
\end{equation}
...
\begin{equation}
    ...
    \begin{aligned}
        ...
        &\quad
        0 &= g^\lambda(\v X_0),\\
        \frac{d x_0}{d\tau} &= g^x(\v X_0),
        &\quad
        \frac{d y_0}{d\tau} &= g^y(\v X_0).
    \end{aligned}
    \right.
\end{equation}
...
$$\begin{pmatrix} (\nabla g^x)_\Lambda \\ (\nabla g^x)_\lambda \end{pmatrix} = \begin{pmatrix} 0 \\ * \end{pmatrix},\qquad \begin{pmatrix} (\nabla g^y)_\Lambda \\ (\nabla g^y)_\lambda \end{pmatrix} = \begin{pmatrix} 0 \\ * \end{pmatrix}.$$
...
$$
\frac{\partial \Lambda_0}{\partial x} = M_{11}, \qquad
\frac{\partial \lambda_0}{\partial x} = M_{21}, \qquad
\frac{\partial \Lambda_0}{\partial y} = M_{12}, \qquad
...
$$G_k^\rho = \sum_{j=2}^{k} \frac{\mathcal{L}_k^{(j)} g^\rho }{j!}, \qquad
\hat G_k^\rho = \sum_{j=2}^{k} \frac{\mathcal{L}_k^{(j)} g^\rho }{(j+1)!}, \qquad
...
$$g^y|_{\lambda_0(\tau),\Lambda_0(\tau),x_0(\tau),y_0(\tau)} = \varepsilon \left( 2F(x_0+\hat x_0)+G -\frac{\partial U}{\partial x} \cos \lambda_0 - \frac{\partial V}{\partial x} \sin \lambda_0 \right) \quad \text{ - четная}.$$
