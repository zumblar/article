...
= \max \left(\frac{1}{|\xi|}, \frac{1}{|\omega|} \right) = \frac{1}{|\xi|} = O \left( \frac{1}{\varepsilon} \right) \quad \text{при достаточно малых $\varepsilon$}.
\end{multline*}
\endgroup
...
\begin{equation*}
    ...
    \begin{aligned}
        ...
        &\quad
        \varepsilon \big( 2F(x+\hat x_0)+G -\tfrac{\partial U}{\partial x} \cos \lambda - \tfrac{\partial V}{\partial x} \sin \lambda \big) &\prec \varepsilon (\varepsilon s + \varepsilon^2 s^2)e^{s}.
    \end{aligned}
    \right.
\end{equation*}
\endgroup
