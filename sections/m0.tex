...
$$M_0 = \{(x, y, \lambda, \Lambda): \quad \Lambda = 0, \quad u(x,y) \sin \lambda = v(x,y) \cos \lambda \}.$$
...
В особых точках, где $U = V = 0$, многообразие имеет вид:
$$y=0,\quad x=x_b^{\pm}\equiv\frac{-e_JD \pm e_J \sqrt{D^2-4EC}}{2C},\quad \Lambda=0,\quad \lambda\in S^1.$$

При физических значениях констант выполняется неравенство $D^2-4EC > 0$ и такой случай соотвествует двум окружностям в $\mathbb{R}^3 \times S^1$.

Локально, вблизи этих окружностей, медленное многообразие имеет структуру винтовой поверхности, описываемой уравнением $\tan\lambda = y/(x-x_b^{\pm})$.
