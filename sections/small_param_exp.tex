...
\begin{equation}
    ...
    \begin{cases}
        ...
        \lambda_k(\tau) = \frac1\beta \Big( \alpha^{-1} \lambda_{k-2}'' - G_k^\Lambda + x_k \big( (2Cx_0+2C \hat x_0+e_JD) \sin\lambda_0 - 2Cy_0 \cos\lambda_0 \big) + \\ \qquad \qquad + y_k \big( -2Cy_0 \sin\lambda_0 - (2Cx_0+2C \hat x_0+e_JD) \cos\lambda_0 \big) \Big),\\
        \lambda_{-1}=0,
    \end{cases}
    }
\end{equation}
