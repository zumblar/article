Рассмотрим систему (\ref{fulltn}) с положением равновесия в начале координат. Линеаризация в окрестности нуля задаётся матрицей:
\[
A = 
\begin{pmatrix}
...
Матрица $A$ имеет собственные значения $\pm i\omega$, $\pm\xi$ и приводится к диагональному виду преобразованием $(z,\eta,a,b)^T = R^{-1}(\Lambda,\lambda,x,y)^T$, где $R$ -- матрица собственных векторов. В новых координатах система принимает вид:
\begin{align}
...
Потребовав вещественность решения в старых переменных $(\Lambda,\lambda,x,y)$, получаем, что амплитуды экспонент должны быть вещественные и равные:
