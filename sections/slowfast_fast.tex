...
Учитывая явный вид функций $U$ и $V$ и условие (\ref{hypa}) \textit{Предположения 1}, получаем, что множество решений алгебраической системы $U(x,y)=0, \quad V(x,y) = 0$ состоит из двух точек:
$$
