...
\begin{document}
    ...
    \section{Динамика в окрестности устойчивого листа}
        ...
        \input{../sections/Wu_Ws}
            ...
            \input{../sections/full_separatrix}

        \subsection{Периодические траектории в окрестности положения равновесия}
        \input{../sections/periodic_introduction}
            \subsubsection{Построение периодических траекторий}
            \input{../sections/periodic}

            \subsubsection{Радиус сходимости рядов}
            \input{../sections/conv_radius}

        \subsection{Устойчивое и нестойчивое многообразия периодических траекторий}
        \input{../sections/periodic_W}
            \subsubsection{Гетероклническое пересечение устойчивого и неустойчивого многообразий}
            \input{../sections/heteroclinic}
    ...
    %\bibliography{mybib} % Указываем имя файла без .bib
